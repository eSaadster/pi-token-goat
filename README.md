...
| `token-goat context-for <file>` | Assemble a minimal context bundle for a file: defined symbols, immediate callers, the matching test file, and the one-level import graph. Enough to work on the file without loading the entire project. |
